...
input EditsUpdateManyInput {
  create: [EditsCreateInput!]
  update: [EditsUpdateWithWhereUniqueNestedInput!]
  upsert: [EditsUpsertWithWhereUniqueNestedInput!]
  delete: [EditsWhereUniqueInput!]
  connect: [EditsWhereUniqueInput!]
  set: [EditsWhereUniqueInput!]
  disconnect: [EditsWhereUniqueInput!]
...
input EditsUpdateWithWhereUniqueNestedInput {
  where: EditsWhereUniqueInput!
  data: EditsUpdateDataInput!
}

input EditsUpsertWithWhereUniqueNestedInput {
  where: EditsWhereUniqueInput!
